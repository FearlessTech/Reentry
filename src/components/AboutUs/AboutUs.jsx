...
const AboutUs = (props) => {
  return (
    <Container>
      <Content className="fearlesstech">
        <Image>
          <img src="/images/Fearless.png" alt="" />
        </Image>
        <Info className="info">
          <AUHeading className="fearlesstech">
          ...
          <Description>
            ...
            <p>
              ...
              <a
                href="https://github.com/orgs/FearlessTech/discussions/5"
      ...
      <Content className="mprn">
        <Image className="image">
          <img src="/images/MPRNaboutme2.jpg" alt="" />
        </Image>
        <Info className="info">
          <AUHeading className="mprn">
            <h1>Maine Prisoner Reentry Network (MPRN)</h1>
          </AUHeading>
          <Description>
            <p>
      ...
      <Content className="mpac">
        <Info className="info">
          <AUHeading className="mpac">
          ...
          <Description>
            ...
            <p>
              ...
              citizens, their families and friends. Our Purpose is to reduce
              Maine’s use of incarceration by advocating for a legal system that
              is ethical, humane, and restorative. Our Vision is of a justice
              system that is restorative. It supports humanity in every person,
              and reflects and creates transformation and accountability.
            </p>
            <br />
            <p>
              ...
              overcome a barrier of lifetime sanctions.
            </p>
            <hr />
            <a
